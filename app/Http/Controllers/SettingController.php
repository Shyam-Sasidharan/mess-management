...
class SettingController extends Controller
{
    ...
    public function update(Request $request, PaymentService $payments): RedirectResponse
    {
        $data = $request->validate([
            ...
            'logo.image' => 'Please upload a valid logo image.',
            'logo.mimes' => 'Logo must be a JPG, PNG, or WEBP image.',
            'logo.max' => 'Logo size must be 5 MB or less.',
            'logo.uploaded' => 'Logo upload failed. Please choose the image again and save.',
        ]);
